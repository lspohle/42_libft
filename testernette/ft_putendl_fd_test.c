...
void	ft_putendl_fd_test(void)
{
    ...
    int     fd = open("../txt_files/ft_putendl_fd_test.txt" , O_RDWR);
    FILE    *fileCheck;
    FILE    *fileTest;
    ...
    fileCheck = fopen("../txt_files/ft_putendl_fd_check.txt", "r");
    fileTest = fopen("../txt_files/ft_putendl_fd_test.txt", "r");
