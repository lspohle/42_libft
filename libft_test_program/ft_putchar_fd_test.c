...
/*   Updated: 2022/12/29 08:25:05 by lspohle          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_putchar_fd_test(void)
{
    ...
    int fd = open("../txt_files/ft_putchar_fd_test.txt" , O_RDWR); // relative path
    FILE    *fileCheck;
    FILE    *fileTest;
    ...
    fileCheck = fopen("../txt_files/ft_putchar_fd_check.txt", "r");
    fileTest = fopen("../txt_files/ft_putchar_fd_test.txt", "r");
